...
<?php
$all = count_ratings( get_the_ID(), 0 );
...
echo '<h4>'. __('Review for','shtheme') .' '. get_the_title() .'<span class="uni-label--count" style="background: rgb(220, 53, 69);">'. $all .'</span></h4>';
...
echo '<div class="row row-small align-middle">';
	...
	echo '<div class="col large-4 small-12 medium-12">';
		echo '<div class="c-rate__right text-center">';
			echo '<p class="small-para">'. __('Have you used this product?','shtheme') .'</p>';
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		jQuery('.uni-review--btn').on('click',function(){
