			...
			<div class="col large-6 pb-0">
				<div class="tabbed-content">
					<ul class="nav nav-uppercase nav-size-normal nav-center">
						<li class="tab has-icon active"><a href="#tab_tab-1-title"><span><?php esc_html_e( 'Login', 'woocommerce' ); ?></span></a></li>

						<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
							<li class="tab has-icon"><a href="#tab_tab-2-title"><span><?php esc_html_e( 'Register', 'woocommerce' ); ?></span></a></li>
						<?php endif;?>
