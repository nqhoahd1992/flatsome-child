		...
		function frontend_wc_listgrid(){
			...
			<div class="uni-toolbox">
				<div class="row row-small align-middle">
					<div class="col large-3 medium-3 hide-for-small"><?php do_action( 'uni_frontend_wc_listgrid' ); ?></div>
					<div class="col large-6 hide-for-medium text-center"><?php woocommerce_result_count(); ?></div>
					<div class="col large-3 medium-9 small-12 uni-ordering"><?php woocommerce_catalog_ordering(); ?></div>
				</div>
			</div>
			<?php
		}
